...
public class TaskManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        taskList.add(new Task("Task-1", "Do this", "Incomplete"));
        taskList.add(new Task("Task-2", "and that", "Complete"));
        taskList.add(new Task("Task-3", "sleep", "Incomplete"));
        System.out.println("All Tasks are:");
        taskList.displayAllTasks();

        System.out.println("\nSearching for task T002:");
        Task task = taskList.search("Task-2");
        if (task != null) {
            task.display();
        } else {
            System.out.println("Task not found.");
        ...
        System.out.println("\nDeleting Task-2:");
        taskList.deleteTaskById("Task-2");
